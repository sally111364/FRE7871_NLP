...
PARM_PATH = r'C:\\Users\\wenca\\Desktop\\2019 Fall\\NLP\\hw1\\data\\'
# Change the file pointer below to reflect your location for the log file
#    (directory must already exist)
PARM_LOGFILE = (r'C:\\Users\\wenca\\Desktop\\2019 Fall\\NLP\\hw1\\result\\' +
...
def download_forms():
    ...
    for year in range(PARM_BGNYEAR, PARM_ENDYEAR + 1):
        for qtr in range(PARM_BGNQTR, PARM_ENDQTR + 1):
            ...
            masterindex=dow30filter(master_index)
